...
async function updateTestimonials() {
  try {
    const testimonials = [
      ...
      { "n": "Pooja Desai", "l": "MUMBAI, IN", "t": "The profit retracement feature is brilliant. It locked my $12 profit right before the market spiked back down. Total peace of mind.", "r": 5 },
      { "n": "Vivek R.", "l": "MUMBAI, IN", "t": "I highly recommend the Coppr Risk Engine for anyone doing manual execution. The latency is practically zero, the hedge executes instantly.", "r": 5 },
      ...
      { "n": "Suresh T.", "l": "DELHI, IN", "t": "Paisa vasool feature. Last Friday NFP news spike would have killed my account, but the $15 emergency trigger locked my balance perfectly.", "r": 5 },
      ...
      { "n": "Nikhil P.", "l": "PUNE, IN", "t": "Very simple to use. Just runs in the background. It locked my profits twice today when Bank Nifty reversed.", "r": 4 },
    ...
    console.log('Injecting clustered testimonials into Coppr Risk Engine...');
    ...
    console.log('Testimonials successfully updated!');
