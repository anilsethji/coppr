        ...
        <AnimatePresence>
          {pending.map((strat) => (
            <motion.div 
              ...
              className="bg-white/[0.02] border border-white/5 rounded-[40px] overflow-hidden group hover:border-[#00E676]/20 transition-all flex flex-col md:flex-row shadow-2xl"
            >
