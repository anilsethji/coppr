    ...
    <div className="w-full min-h-screen py-20 px-4 flex items-center justify-center">
      <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="card p-8 shadow-2xl bg-[#0A0F1E] border-white/10 h-fit">
           ...
           {error && (
             <div className="bg-red-500/10 border border-red-500/20 text-red-500 text-xs p-3 rounded-card mb-4 text-center">
               {error}
             </div>
           )}
           ...
           <div className="flex items-start mb-8">
            <input 
              type="checkbox" 
              className="mt-1 w-5 h-5 min-w-[20px] rounded border-gray-600 outline-none accent-green-electric" 
          ...
          <button 
            ...
            disabled={loading}
            className={`btn-primary w-full py-4 text-lg shadow-[0_4px_20px_0_rgba(0,230,118,0.3)] mb-6 flex flex-col items-center justify-center ${loading ? 'opacity-50' : ''}`}
          >
          ...
          <div className="text-center text-xs text-gray-500 flex flex-col items-center gap-2">
            <span className="flex items-center gap-1"><span className="text-gold-badge">🔒</span> Secured by Cashfree Payments</span>
